...
import { ILitecoinTransaction, ILitecoinTransactionNative, IUnspentTransaction } from "./ILitecoinResponses";
...
export class LitecoinService {
    ...
    ): Promise<Array<ILitecoinTransaction>> {
    ...
    public async getNativeTransaction(id: string) {
